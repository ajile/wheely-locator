...
Services.SessionService = {
    ...
    initialize: function(container, application) {
        ...
        // todo: Вытащить это отсюда, но пока не знаю куда. Наверное в отдельный
        //       инициализоватор, которой будет выполняться сразу после
        //       `session` и `connection` инициализаторов.
